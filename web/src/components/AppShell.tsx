...
const destinations = [
  ...
  ["parties", "/app/parties", "◎", "Parties"],
  ["invoices", "/app/invoices", "▤", "Invoices"],
  ["cash-plan", "/app/cash-plan", "↗", "Cash plan"],
  ["scenarios", "/app/scenarios", "◇", "Scenarios"],
    ...
    <div className="app-page">
      ...
      <aside className="app-sidebar">
        ...
        <div className="sidebar-bottom">
          ...
          {preview ? (
            <a href="/login">
              <span aria-hidden="true">↪</span> Leave preview
            </a>
          ) : (
          ...
          <div className="user-chip">
            <span>FV</span>
            <div>
              <strong>{user?.workspaceName ?? "Demo workspace"}</strong>
              <small>{user?.email ?? "Sample data"}</small>
            </div>
          </div>
        </div>
      </aside>
      <header className="mobile-app-header">
        <Brand />
        <a href={preview ? "/app/preview" : "/app"}>Overview</a>
      </header>
      {children}
      <nav
