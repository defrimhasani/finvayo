...
const alertVariants = cva("relative w-full border p-4 text-sm", { variants: { variant: { default: "border-border bg-card text-foreground", destructive: "border-destructive bg-[#f2ddd7] text-[#6f2e26]", success: "border-teal bg-[#d8e4dc] text-[#17453d]" } }, defaultVariants: { variant: "default" } });
